...
class OperationNotificationGroupingPolicyTest {
    ...
    @Test
    fun x11OnlyOperationNotificationsUseOneExplicitAndroidGroup() {
        ...
        assertTrue(source.contains("GROUP_SUMMARY_ID"))
        assertTrue(source.contains("syncGroupSummary(context)"))
    }
}
